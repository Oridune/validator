...
import {
  ...
  DateValidator,
  EnumValidator,
  type IAndValidatorOptions,
  type IAnyValidatorOptions,
  type IArrayValidatorOptions,
  type IBigIntValidatorOptions,
  type IBooleanValidatorOptions,
  type IDateValidatorOptions,
  type IEnumValidatorOptions,
  IfValidator,
  type IIfValidatorOptions,
  type IInstanceOfValidatorOptions,
  InstanceOfValidator,
  type INullValidatorOptions,
  type INumberValidatorOptions,
  type IObjectValidatorOptions,
  type IOptionalValidatorOptions,
  type IOrValidatorOptions,
  type IRecordValidatorOptions,
  type IStringValidatorOptions,
  type ITupleValidatorOptions,
  type IUndefinedValidatorOptions,
...
const Validators = {
  ...
  >(
    ...
    >(
      a instanceof Array ? a : [a as any, b as any],
      a instanceof Array ? b as any : options,
    ),
